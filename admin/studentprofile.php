      ...
      <div class="py-4 text-gray-500 dark:text-gray-400 bg-green-50">
        <div class="py-2 text-gray-500 dark:text-gray-400 flex items-center">
          <a href="https://kristujayanti.edu.in" class="mr-2">
            <img src="img/kjc.png" alt="College Logo" width="90" height="90" class="rounded-full" style="text-align: center;">
          </a>
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  <thead class="table-light>
                    ...
                    <th class="px-4 py-3" style="text-align: center;">Register No.</th>
                    <th class="px-4 py-3" style="text-align: center;">Department</th>
                    <th class="px-4 py-3" style="text-align: center;">Phone No.</th>
