...
<head>
  ...
  <style>
    ...
    .input-group-prepend .input-group-text {
      display: flex;
      align-items: center;
      height: calc(2.25rem + 2px); /* Ensures the height of the input group matches the input fields */
    }
    ...
    .form-control {
      height: calc(2.25rem + 2px); /* Ensures the height of the input field */
    }
          ...
          <form action="user_index.php" method="post" id="login-form">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="username" name="email" placeholder="Enter your Reg No." required>
              </div>
            </div>
            <div class="form-group">
