  ...
  <body>
    ...
    <div class="container pt-5">
			<div class="row justify-content-between">
				<div class="col">
					<a class="navbar-brand" href="index.html">PLACERS<span>Placement Management System</span></a>
				</div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="blog.html" class="nav-link">Our Recruiter</a></li>
					...
					<div class="col-md-9 py-5">
		              ...
		              <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title="Instagram"><span class="ion-logo-instagram"></span></a></li>
						...
						<div class="row mt-md-5">
							<div class="col-md-12">
								<p class="copyright"> Visit our College website for more details  <a href="https://colorlib.com" target="_blank">Colorlib.com</a>
</p>
							</div>
						</div>
					</div>
